...
import com.example.coffee.databinding.ViewholderSizeBinding
...
class SizeAdapter (val items: MutableList<String>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):SizeAdapter.Viewholder { context = parent.context
        val binding =
    ...
    override fun onBindViewHolder (holder: SizeAdapter.Viewholder, position: Int) {
        ...
        if(selectedPosition==position){
            holder.binding.picsize.setBackgroundResource(R.drawable.orange_bg)
        }
        else{
            holder.binding.picsize.setBackgroundResource(R.drawable.size_bg)
        }
        ...
        val layoutParams=holder.binding.picsize.layoutParams
        layoutParams.width=imageSize
        layoutParams.height =imageSize
        holder.binding.picsize.layoutParams=layoutParams
    }
